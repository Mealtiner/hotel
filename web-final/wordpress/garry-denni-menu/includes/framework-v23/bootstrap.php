...
function bootstrap( $plugin_file, $own_callback = null, $own_tab_label = 'Nastavení' ) {
	$descriptor = array(
		 ...
		 */
		'changelog' => array(
			array( 'version' => '1.13.0', 'date' => '2026-09-08', 'notes' => 'Sazba dlouhých nabídek do sloupců přesunuta z child motivu do pluginu (assets/jidelnicek.css + assets/jidelnicek.js) — patří k vykreslování jídelníčku, ne k webu, na kterém běží. Pravidla: počet sloupců podle počtu položek (4/3/2/1, pod 5 položek vždy jeden), vyrovnané výšky, položka se nikdy nedělí mezi sloupce, klíč skupiny nezůstane sám na konci sloupce a vrchy sloupců jsou srovnané. Odsazení, které po přeuspořádání zůstalo viset uprostřed sloupce, se nově odebere. Assety se načítají jen na stránkách s jídelníčkem; filtr garry_menu_nacist_sazbu umí načtení vynutit.' ),
			array( 'version' => '1.12.0', 'date' => '2026-09-08', 'notes' => 'Nápojový lístek dostal nadpis nabídky — jako jediný ho neměl a tvářil se jako pokračování předchozího menu.' ),
			array( 'version' => '1.11.0', 'date' => '2026-09-08', 'notes' => 'Shortcode [grid_menu_provozy] přijímá nadpis="ne" pro případ, kdy nadpis nese sekce stránky a druhý by se opakoval.' ),
			array( 'version' => '1.10.0', 'date' => '2026-09-08', 'notes' => 'Skupina jídelníčku se vykresluje jako <dl> (název jídla dt, cena dd) a popisek skupiny je k seznamu připojený přes aria-labelledby, aby čtečka ohlásila, o jakou část nabídky jde (WCAG 1.3.1). Vykreslování skupiny sjednoceno do jedné funkce garry_gm_skupina() — dřív bylo čtyřikrát zkopírované. Srovnána konstanta GARRY_MENU_VER, která zůstala na 1.8.0.' ),
			array( 'version' => '1.9.0', 'date' => '2026-09-07', 'notes' => 'Nový shortcode [grid_menu_provozy] — jídelníček všech provozů pod sebou, v pořadí podle nastavení a jen s nabídkami, které má provoz zaškrtnuté. Přidání, přejmenování i smazání provozu se propíše na web samo, ve stránce nezůstává nic natvrdo. Kotva sekce je jidelnicek-<slug provozu>.' ),
