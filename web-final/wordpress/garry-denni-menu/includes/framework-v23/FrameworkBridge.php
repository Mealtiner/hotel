...
final class FrameworkBridge {
	...
	private function page_config( $display_name ) {
		return array(
			...
			/**
			 * Dynamické vlastní taby (verze s víc provozy) – nepovinné, čte
			 * LocalAdmin::render_tabs()/render(). Zdroj je funkce v hlavním
			 * souboru pluginu, ne nový sdílený registr.
			 */
			'own_tabs' => function_exists( 'garry_menu_own_tabs' ) ? garry_menu_own_tabs() : array(),
			/**
			 * Historie verzí pro Info tab (viz LocalAdmin::render_info()) –
			 * standing požadavek: každá úprava pluginu se loguje i v adminu,
			 * ne jen v README.md.
			 */
