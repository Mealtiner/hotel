...
function bootstrap( $plugin_file, $own_callback = null, $own_tab_label = 'Nastavení' ) {
	$descriptor = array(
		...
		'changelog' => array(
			array( 'version' => '2.11.0', 'date' => '2026-09-08', 'notes' => 'Akce bez data se nabízí i ve formuláři — prázdné datum se dřív vyhodnotilo jako dávno minulé a akce z výběru vypadla. Pořadí voleb ve formuláři odpovídá výpisu na webu, vlajková akce první.' ),
			array( 'version' => '2.10.0', 'date' => '2026-09-08', 'notes' => 'Texty stavů termínu (volno / poslední pokoje / vyprodáno) a popisky tlačítek se předávají do motivu podle jazyka stránky; dřív byly natvrdo česky.' ),
			array( 'version' => '2.9.0', 'date' => '2026-09-08', 'notes' => 'Vlajková akce sezóny: široká karta v čele výpisu s obrysem trati, zvýrazněný řádek v seznamu termínů a první místo ve formuláři.' ),
			array( 'version' => '2.8.0', 'date' => '2026-09-08', 'notes' => 'Doplněn přepínač Prime v datech akce (uložení, sanitizace, řazení i zaškrtávátko v administraci) — příprava pro vlajkovou akci sezóny.' ),
			array( 'version' => '2.7.3', 'date' => '2026-09-06', 'notes' => 'Oprava regrese z 2.7.0: limit=0 v shortcodu zase znamena bez omezeni, takze stranka Sezona vypisuje vsechny pripravovane akce. Nastaveni maximalniho poctu se uplatnuje na zkraceny vypis, kde shortcode limit neuvadi. Rozlisit neuvedeny atribut od limit=0 slo jen tak, ze limit neni v shortcode_atts.' ),
