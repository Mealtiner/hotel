...
function bootstrap( $plugin_file, $own_callback = null, $own_tab_label = 'Nastavení' ) {
	$descriptor = array(
		...
		'changelog' => array(
			array( 'version' => '1.8.0', 'date' => '2026-09-07', 'notes' => 'Záhlaví obou tabulek (přehled i srovnání) má scope="col", aby čtečka svázala buňku se sloupcem (WCAG 1.3.1).' ),
			array( 'version' => '1.7.0', 'date' => '2026-09-07', 'notes' => 'Název kategorie v kartě je <h2> místo <h3> — karty stojí přímo pod nadpisem sekce, takže úroveň h3 přeskakovala jeden stupeň osnovy (WCAG 1.3.1).' ),
			array( 'version' => '1.6.0', 'date' => '2026-09-06', 'notes' => 'Novy shortcode [grid_rooms_gallery] — fotky ze vsech kategorii pokoju v jedne galerii, snimky z termmeta (nahled + galerie). Vykresleni prenechava pluginu GARRY – Foto lightbox, bez nej vykresli prostou mrizku odkazu.' ),
