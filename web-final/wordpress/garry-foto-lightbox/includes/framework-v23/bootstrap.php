...
function bootstrap( $plugin_file, $own_callback = null, $own_tab_label = 'Nastavení' ) {
	$descriptor = array(
		...
		'changelog' => array(
			array( 'version' => '1.4.0', 'date' => '2026-09-07', 'notes' => 'Skrytý odkaz na další galerii už nenese prázdné href="#" — <a> bez href není odkaz, takže nezasahuje do pořadí procházení ani do výpisu odkazů.' ),
			array( 'version' => '1.3.0', 'date' => '2026-09-07', 'notes' => 'Dlaždice galerie dostala aria-label složený z názvu fotky a pořadí („… — zvětšit fotku 2 z 8“); bez něj ji čtečka ohlásila jen jako „odkaz“. Alt obrázku je nově prázdný, aby se stejný text nečetl dvakrát.' ),
