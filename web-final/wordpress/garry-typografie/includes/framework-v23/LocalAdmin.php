...
final class LocalAdmin {
	...
	private static function render_info( array $config ) {
		...
		<?php
		/**
		 * Historie verzí (standing požadavek: každá úprava pluginu se loguje
		 * i v adminu, ne jen v README.md). Nepovinné pole 'changelog' v
		 * deskriptoru (viz bootstrap.php) – prázdné, dokud ho plugin
		 * nezačne plnit.
		 */
