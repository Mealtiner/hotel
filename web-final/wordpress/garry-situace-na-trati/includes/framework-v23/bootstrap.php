...
function bootstrap( $plugin_file, $own_callback = null, $own_tab_label = 'Nastavení' ) {
	$descriptor = array(
		...
		'changelog' => array(
			array( 'version' => '1.6.0', 'date' => '2026-09-07', 'notes' => 'Hodnoty, které se aktualizují za běhu (stav trati, počasí, povrch), se čtečce ohlásí přes role="status" aria-live="polite". Hodiny záměrně ne — tikaly by každou vteřinu (WCAG 4.1.3).' ),
