<?php
/**
 * GARRY Embedded Framework 2.4 – bootstrap pro plugin garry-informacni-bublina-2.
...
function bootstrap( $plugin_file, $own_callback = null, $own_tab_label = 'Nastavení' ) {
	$descriptor = array(
		'slug'               => 'garry-informacni-bublina-2',
		'name'               => 'GARRY – Informační bublina 2',
		'plugin_version'     => '2.0.0',
		'framework_protocol' => Protocol::VERSION,
		'framework_major'    => Protocol::MAJOR,
		'framework_minimum'  => '2.4.0',
		'framework_priority' => 370,
		'local_menu_slug'    => 'garry-informacni-bublina-2',
		...
		'doc' => '<p>Vyskakovací bublina s vlastním obsahem pro každou stránku. <strong>Vzhled</strong> (barvy, rozměry, pozice, chování) se nastavuje zde v GARRY nastavení a platí pro celý web. <strong>Obsah</strong> pro jednotlivé stránky — šablona, text ve třech jazycích a doprovodná fotka — se zadává v <strong>GRID Nastavení → Informační bublina</strong>. Jeden záznam platí pro stránku i všechny její jazykové mutace.</p>',
		'changelog' => array(
			array( 'version' => '2.0.0', 'date' => '2026-09-06', 'notes' => 'Přepis původní Informační bubliny pro GRID Hotel. Nově pět šablon (čtverec s textem, dva obdélníky na šířku a dva na výšku s fotkou), obsah zvlášť pro každou stránku ve třech jazycích, fotka z knihovny médií, oddělení vzhledu (GARRY nastavení) od obsahu (GRID Nastavení).' ),
		),
	);
