	...
	<section class="sec sec-light sec-pad grid-component grid-component--kontakt" style="padding-top:clamp(120px,16vh,180px)">
	  <div class="wrap">
	    ...
	    <div class="kontakt-grid">
	      <div class="k-info">
	        <div class="k-block"><h3>Adresa</h3><address><?php echo esc_html( $a1 ); ?><br><?php echo esc_html( $a2 ); ?></address><a class="btn btn-ghost" href="<?php echo esc_url( $navig ); ?>" target="_blank" rel="noopener">Navigovat →</a></div>
	...
	<section class="sec sec-dark carbon sec-pad">
	  <div class="wrap">
	    ...
	    <div class="dp-air-grid">
	      <div class="dp-airport"><div class="dp-head"><h4>Letiště Brno</h4><span class="dp-badge">25 km</span></div><p>Použijte dálnici D1 a exit 182 Kývalka, poté sledujte směrovky „Grand Prix" či „Paddock".</p><span class="dp-vign">Dálniční známka: CZ</span><div class="dp-akce"><a class="sec-more" href="https://www.google.com/maps/dir/?api=1&origin=Leti%C5%A1t%C4%9B%20Brno-Tu%C5%99any%2C%20Brno&destination=GRID%20HOTEL%2C%20Ostrova%C4%8Dick%C3%A1%20936/65%2C%20641%2000%20Brno-%C5%BDeb%C4%9Bt%C3%ADn" target="_blank" rel="noopener">Navigovat do hotelu <span aria-hidden="true">&nearr;</span></a><a class="sec-more" href="https://www.brno-airport.cz/" target="_blank" rel="noopener">Web letiště <span aria-hidden="true">&nearr;</span></a></div></div>
	      <div class="dp-airport"><div class="dp-head"><h4>Praha – Ruzyně</h4><span class="dp-badge">210 km</span></div><p>Pražský okruh, dále dálnice D1 a exit 178 Ostrovačice, poté směrovky „Grand Prix" či „Paddock".</p><span class="dp-vign">Dálniční známka: CZ</span><div class="dp-akce"><a class="sec-more" href="https://www.google.com/maps/dir/?api=1&origin=Leti%C5%A1t%C4%9B%20V%C3%A1clava%20Havla%20Praha&destination=GRID%20HOTEL%2C%20Ostrova%C4%8Dick%C3%A1%20936/65%2C%20641%2000%20Brno-%C5%BDeb%C4%9Bt%C3%ADn" target="_blank" rel="noopener">Navigovat do hotelu <span aria-hidden="true">&nearr;</span></a><a class="sec-more" href="https://www.prg.aero/" target="_blank" rel="noopener">Web letiště <span aria-hidden="true">&nearr;</span></a></div></div>
	      <div class="dp-airport"><div class="dp-head"><h4>Vídeň – Schwechat</h4><span class="dp-badge">160–200 km</span></div><p><strong style="color:var(--fg)">Trasa 1:</strong> A4 (E85) směr Bratislava → D2 do Brna → D1, exit 182 Kývalka (200 km).</p><p><strong style="color:var(--fg)">Trasa 2:</strong> A4 → A23 → S1 → A5 → silnice 7 směr Brno → I/52 (R52) → D1 směr Praha, exit 182 Kývalka (160 km).</p><span class="dp-vign">Dálniční známky: AT, SK, CZ</span><div class="dp-akce"><a class="sec-more" href="https://www.google.com/maps/dir/?api=1&origin=Flughafen%20Wien-Schwechat&destination=GRID%20HOTEL%2C%20Ostrova%C4%8Dick%C3%A1%20936/65%2C%20641%2000%20Brno-%C5%BDeb%C4%9Bt%C3%ADn" target="_blank" rel="noopener">Navigovat do hotelu <span aria-hidden="true">&nearr;</span></a><a class="sec-more" href="https://www.viennaairport.com/" target="_blank" rel="noopener">Web letiště <span aria-hidden="true">&nearr;</span></a></div></div>
	      <div class="dp-airport"><div class="dp-head"><h4>Bratislava</h4><span class="dp-badge">150 km</span></div><p>Dálnicí D2 do Brna a poté dálnicí D1 směr Praha, exit 182 Kývalka.</p><span class="dp-vign">Dálniční známky: SK, CZ</span><div class="dp-akce"><a class="sec-more" href="https://www.google.com/maps/dir/?api=1&origin=Letisko%20M.%20R.%20%C5%A0tef%C3%A1nika%20Bratislava&destination=GRID%20HOTEL%2C%20Ostrova%C4%8Dick%C3%A1%20936/65%2C%20641%2000%20Brno-%C5%BDeb%C4%9Bt%C3%ADn" target="_blank" rel="noopener">Navigovat do hotelu <span aria-hidden="true">&nearr;</span></a><a class="sec-more" href="https://www.bts.aero/" target="_blank" rel="noopener">Web letiště <span aria-hidden="true">&nearr;</span></a></div></div>
	    </div>
	  </div>
	</section>
	<?php return ob_get_clean();
