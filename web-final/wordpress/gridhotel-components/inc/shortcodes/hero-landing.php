	...
	<section class="sec sec-light sec-pad grid-component grid-component--rezervace" style="padding-top:clamp(120px,16vh,180px)">
	  <div class="wrap">
	    ...
	    <div class="bkmock" aria-hidden="true">
	      ...
	      <div class="bkmock-head"><h3>Rezervace ubytování</h3><div class="bkmock-promo"><input type="text" placeholder="Zadejte promo kód" disabled><span class="bkmock-btn red">Potvrdit</span></div></div>
