...
function bootstrap( $plugin_file, $own_callback = null, $own_tab_label = 'Nastavení' ) {
	$descriptor = array(
		...
		'changelog' => array(
			array( 'version' => '2.4.0', 'date' => '2026-09-07', 'notes' => 'Nový modul inc/seo.php: hreflang pro stránky kategorií pokojů (Polylang je pro tuhle taxonomii nevypisuje, ačkoli jsou překlady termů propojené) a strukturovaná data typu LodgingBusiness s adresou, telefonem a časy check-inu (Yoast umí jen Organization).' ),
			array( 'version' => '2.1.0', 'date' => '2026-09-07', 'notes' => 'Srovnán manifest, který zůstal na 2.0.2, zatímco hlavička pluginu i konstanta GRIDCORE_VER běžely dál.' ),
