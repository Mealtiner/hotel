<?php
/**
 * inc/garry.php — napojení GRID Hotel Core na sdílený rámec GARRY Promotion.
 *
 * Cíl:
 *  - GRID Hotel Core se chová jako plnohodnotný GARRY plugin: registruje se do
 *    přehledu „GARRY nastavení" (objeví se jako nainstalovaný/aktivní).
 *  - Když je Core aktivní, položka „GARRY nastavení" se v menu zobrazí i bez
 *    ostatních mikropluginů (rámec je idempotentní, sdílí se přes globální registr).
 *  - Do GARRY se přenáší POUZE rozcestník „Nastavení webu" (odkaz na ACF options
 *    stránku grid-options). Vlastní menu „GRID Nastavení" i CPT (Pokoje, Zážitky,
 *    Akce, Gastro, Reference) zůstávají tam, kde jsou.
 */
...
/* ============================================================================
 * GRID Hotel Core → registrace do přehledu GARRY + rozcestník „Nastavení webu"
 * ============================================================================ */

Garry_Promotion_Registry::register( array(
	'slug'        => 'gridcore-nastaveni-webu',
...
/* Rozcestník „Nastavení webu" uvnitř GARRY nastavení.
 * Vlastní pole se needitují zde — jsou na ACF options stránce grid-options
 * pod menu „GRID Nastavení". Tady je jen vstupní bod + rychlé odkazy. */
function gridcore_garry_web_settings_page() {
	...
	<div class="wrap">
	  ...
	  <p style="margin-top:22px;color:#666;font-size:12px">GRID Hotel Core v<?php echo esc_html( defined( 'GRIDCORE_VER' ) ? GRIDCORE_VER : '' ); ?> — součást ekosystému GARRY Promotion.</p>
	</div>
	<?php
}
