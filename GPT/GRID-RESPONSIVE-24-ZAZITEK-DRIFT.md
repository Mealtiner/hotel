# GRID Hotel — Detail zážitku — Drift & Gangster kurz

## Rozsah

- URL: kanonický CPT slug, očekávaně `/zazitky/drift-gangster-kurz/`
- Datový obsah: popis kurzu, termíny, parametry, CTA
...
Ampersand, termíny a případný externí widget musí zůstat uvnitř koridoru.
