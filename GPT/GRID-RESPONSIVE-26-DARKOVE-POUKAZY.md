# GRID Hotel — Dárkové poukazy

## Rozsah

- URL: kanonický CPT/page slug, očekávaně `/zazitky/darkove-poukazy/`
- Datový obsah: cenové varianty, popis doručení, objednávkový formulář
...
Poukazové karty jsou nyní na tabletech pod minimální šířkou; formulář musí být nezávislý na kartách.
