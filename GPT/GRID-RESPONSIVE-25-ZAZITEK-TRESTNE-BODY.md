# GRID Hotel — Detail zážitku — Odpočet trestných bodů

## Rozsah

- URL: kanonický CPT slug, očekávaně `/zazitky/odpocet-trestnych-bodu/`
- Datový obsah: akreditace, podmínky, termíny, CTA
...
Právně důležité podmínky nesmí být ořezané ani schované v hoveru.
