# GRID Hotel — Detail pokoje Standard

## Rozsah

- URL: `/kategorie-pokoje/standard/`
- Datový obsah: 1–2 osoby, cca 24 m², fotografie exteriéru/pokoje, vybavení Standard
- Zdroj: taxonomy/CPT šablona `taxonomy-grid_room_cat.php` + Kategorie pokojů plugin
...
Nejdelší seznam základního vybavení a případné cenové řádky musí bezpečně zalamovat.
