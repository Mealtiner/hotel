# GRID Hotel — Detail zážitku — Motokáry a pitbike

## Rozsah

- URL: kanonický CPT slug, očekávaně `/zazitky/motokary-pitbike/`
- Datový obsah: hero/media, dvojí typ zážitku, bezpečnostní údaje, rezervace
...
Dvojitý název a delší CTA nesmí vytlačit aside ani cenu.
