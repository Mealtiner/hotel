# GRID Hotel — Detail zážitku — Simulátor okruhu

## Rozsah

- URL: `/zazitky/simulator-okruhu/`
- Datový obsah: hero/media, popis simulátoru, parametry, rezervace/CTA
...
Tato URL byla přímo auditována; mobilní overflow byl přibližně +77 px.
